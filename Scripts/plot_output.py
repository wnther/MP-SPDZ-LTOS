...
def plot_network():
    plot_experiment(
        ...
        [
            (all_experiments["ltos_fake_network_local_L-0_B-inf"]["total_time"], "ltos_0_latency", "ltos"),
            (all_experiments["ltos_fake_network_local_L-50_B-inf"]["total_time"], "ltos_50_latency", "ltos"),
            (all_experiments["ltos_fake_network_local_L-100_B-inf"]["total_time"], "ltos_100_latency", "ltos"),
            (all_experiments["ltos_fake_network_local_L-150_B-inf"]["total_time"], "ltos_150_latency", "ltos"),
    ...
    plot_experiment(
        ...
        all_experiments["ltos_fake_network_local_L-0_B-inf"]["m"],
        [
            (all_experiments["ltos_fake_network_local_L-0_B-inf"]["total_time"], "ltos_unlimited", "ltos"),
            (all_experiments["ltos_fake_network_local_L-0_B-100Mbps"]["total_time"], "ltos_100Mbps", "ltos"),
            (all_experiments["ltos_fake_network_local_L-0_B-10Mbps"]["total_time"], "ltos_10Mbps", "ltos"),
            (all_experiments["ltos_fake_network_local_L-0_B-1.544Mbps"]["total_time"], "ltos_1.544Mbps", "ltos"),
    	    (all_experiments["waksman_based_fake_network_local_L-0_B-inf"]["total_time"], "waksman-based_0_latency"),
